<template>
  <svg width="56" height="56" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M21.398 18.003a1.5 1.5 0 00-1.395 1.599l1.5 22a1.5 1.5 0 102.994-.204l-1.5-22a1.5 1.5 0 00-1.599-1.395zm13.204 0a1.5 1.5 0 011.395 1.599l-1.5 22a1.5 1.5 0 11-2.994-.204l1.5-22a1.5 1.5 0 011.599-1.395z"
      fill="currentColor"
    />
    <path
      fill-rule="evenodd"
